...
class WhatsAppButton {
    ...
    this.options = Object.assign(
      {
        ...
        defaultMessage:
          "Hello, I'd like to inquire about your logistics services.",
  ...
  createElements() {
    ...
    this.button.className =
      "btn btn-lg rounded-circle shadow-lg whatsapp-button";
    ...
    this.chatHeader.style.backgroundColor = "#FD0000";
    ...
    this.avatar.innerHTML =
      '<img src="/img/lighlogo.webp" alt="Logo" style="width: 30px; height: 30px; object-fit: contain;">';
    ...
    this.chatBody.style.backgroundImage =
    ...
    this.timeIndicator.innerHTML = `<small class="text-muted">${this.formatTime(
      this.currentTime
    )}</small>`;
    ...
    this.chatFooter.className =
      "card-footer d-flex justify-content-center py-3";
    ...
    this.startChatButton.innerHTML =
