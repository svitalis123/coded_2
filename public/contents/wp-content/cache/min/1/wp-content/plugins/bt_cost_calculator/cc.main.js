(function ($) {
  var is_rtl = !1;
  var rtl_direction = 1;
  window.bt_cc_subtotal =
    ";var setSubtotal = function( id, val, ignore_format ) {" +
  ...
  window.bt_cc_eval_conditions = function (val, conditions) {
    if (conditions == "" || conditions == undefined) return !1;
    if (val == "") val = 0;
