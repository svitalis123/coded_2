...
(function ($) {
  ...
  function dd(element, settings) {
    ...
    var _construct = function () {
      ...
      if (Boolean(useCheckbox) === !0) {
        getElement(_element).multiple = !0;
        _settings.enableCheckbox = !0;
      }
      _isList =
        getElement(_element).size > 1 || getElement(_element).multiple == !0
          ? !0
          : !1;
      if (_isList) {
    ...
    var _createChild = function (opt) {
      ...
      if (_settings.enableCheckbox === !0) {
        ...
        if (_settings.enableCheckbox === !0) {
          chkbox.checked = opt.selected ? !0 : !1;
        }
      }
      if (oIcon) {
        oIconParent.appendChild(oIcon);
    ...
    var _childHeight = function (val) {
      ...
      if (getElement(_element).options.length > _settings.visibleRows) {
        ...
        if (_settings.rowHeight === 0) {
          ...
          if (!_isList || _settings.enableCheckbox === !0) {
    ...
    var _applyChildEvents = function () {
        ...
        if (_isList === !0) {
          if (_isMultiple) {
            if (_shiftHolded === !0) {
              ...
              $("#" + childid + " input:checkbox").prop("checked", !1);
              $(this).addClass(_styles.selected);
              if (_settings.enableCheckbox === !0) {
                this.childNodes[0].checked = !0;
              }
            }
          } else {
            $("#" + childid + " li." + _styles.selected).removeClass(
      ...
      $("#" + childid + " li." + _styles.enabled).on("mouseup", function (e) {
        ...
        _forcedTrigger =
          _oldSelected.length != selected || selected == 0 ? !0 : !1;
        _fireAfterItemClicked();
        _unbind_on_events();
        _bind_on_events();
        _lastTarget = null;
      });
      if (_settings.disabledOptionEvents == !1) {
    ...
    var _fixedForList = function () {
      var id = _getPostID("postID");
      var childid = _getPostID("postChildID");
      if (_isList === !0 && _settings.enableCheckbox === !1) {
        $("#" + id + " ." + _styles.ddTitle).hide();
        $("#" + childid).css({ display: "block", position: "relative" });
      } else {
        if (_settings.enableCheckbox === !1) {
          _isMultiple = !1;
        }
    ...
    var _fixedForDisabled = function () {
      var id = _getPostID("postID");
      var opc = _isDisabled == !0 ? _settings.disabledOpacity : 1;
      if (_isDisabled === !0) {
    ...
    var has_handler = function (name) {
      var evt = { byElement: !1, byJQuery: !1, hasEvent: !1 };
      var obj = $("#" + _element);
      try {
    ...
    var _showFilterBox = function () {
      var tid = _getPostID("postTitleTextID");
      if ($("#" + tid + ":hidden").length > 0 && _controlHolded == !1) {
        $("#" + tid + ":hidden")
          .show()
          .val("");
    ...
    var on_keydown = function (evt) {
      ...
      switch (evt.keyCode) {
        ...
        case CONTROL:
          ...
          break;
        default:
          if (evt.keyCode >= ALPHABETS_START && _isList === !1) {
          }
          break;
      }
      if (_isDisabled === !0) return !1;
    ...
    var fireOptionEventIfExist = function (li, evt_n) {
      if (_settings.disabledOptionEvents == !1) {
        ...
        if (option_has_handler(opt, evt_n).hasEvent === !0) {
          if (option_has_handler(opt, evt_n).byElement === !0) {
            opt["on" + evt_n]();
          }
          if (option_has_handler(opt, evt_n).byJQuery === !0) {
            switch (evt_n) {
              case "keydown":
              case "keyup":
                break;
    ...
    var fireEventIfExist = function (evt_n) {
      ...
      if (has_handler(evt_n).hasEvent === !0) {
        if (has_handler(evt_n).byElement === !0) {
          getElement(_element)["on" + evt_n]();
        }
        if (has_handler(evt_n).byJQuery === !0) {
          switch (evt_n) {
            case "keydown":
            case "keyup":
              break;
    ...
    var _next = function () {
      ...
      function getNext(ind) {
        ...
        if ($(items[ind]).hasClass(_styles.enabled) === !0) {
          return ind;
        }
    ...
    var _close = function (e) {
      ...
      var id = _getPostID("postID");
      var childid = _getPostID("postChildID");
      if (_isList === !1 || _settings.enableCheckbox === !0) {
        $("#" + childid).css({ display: "none" });
        $("#" + id)
    ...
    var _mergeAllProp = function () {
      _orginial = $.extend(!0, {}, getElement(_element));
    ...
    this.set = function (prop, val) {
      if (typeof prop == "undefined" || typeof val == "undefined") return !1;
      prop = prop.toString();
      try {
      ...
      switch (prop) {
        case "size":
          ...
          if (val == 0) {
            getElement(_element).multiple = !1;
          }
          _isList =
            getElement(_element).size > 1 || getElement(_element).multiple == !0
              ? !0
    ...
    this.visible = function (val) {
      ...
      if (val === !0) {
        ...
        return $("#" + id).css("display") == "none" ? !1 : !0;
      }
    };
