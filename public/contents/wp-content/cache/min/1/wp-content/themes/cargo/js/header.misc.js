...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    stickyOffset = 250;
    var swapHeaderStyle =
      belowMenu && stickyEnabled && $(".btAltLogo").length > 0;
    var skinToSwap = $("body").hasClass("btDarkSkin")
      ? "btLightSkin"
      : "btDarkSkin";
    $(".btPageWrap .btAltLogo").hide();
    $(".btPageWrap .btMainLogo").show();
    function divide_menu() {
      if (!hasCentralMenu) return !1;
      ...
      var halfItems = Math.ceil(
        $(".mainHeader nav.leftNav ul>li:not(li li)").length * 0.5
      );
      $(".mainHeader nav.rightNav > ul").append(
        $(".mainHeader nav.leftNav > ul > li").slice(halfItems)
      );
      ...
      $(".mainHeader nav.leftNav").css(
        "margin-right",
        Math.round(logoWidth * 0.5) + "px"
      );
      $(".mainHeader nav.rightNav").css(
        "margin-left",
        Math.round(logoWidth * 0.5) + "px"
      );
    }
    function undivide_menu() {
      if (!hasCentralMenu) return !1;
      $(".mainHeader nav.leftNav>ul:not(ul ul)").append(
        $(".mainHeader nav.rightNav ul>li:not(li li)")
      );
    ...
    function init_menu() {
      if (verticalMenuEnabled) {
        ...
        $("body").removeClass(
          "btMenuVerticalLeft btMenuVerticalRight btMenuVerticalOn"
        );
        if ($("body").hasClass("btMenuRightEnabled"))
          $("body").addClass("btMenuRight");
        if ($("body").hasClass("btMenuLeftEnabled"))
          $("body").addClass("btMenuLeft");
        if ($("body").hasClass("btMenuCenterEnabled"))
          $("body").addClass("btMenuCenter");
      }
    }
          ...
          $("html, body").animate(
            {
              scrollTop:
                ...
                $(".mainHeader .port").height() -
                $(".mainHeader .btCurveHeader").height(),
            },
            0
          );
        }
    ...
    $(".menuPort ul ul")
      .parent()
      .prepend(
        '<div class="btIco borderless extrasmall subToggler"><a href="#" data-ico-fa="&#xf107;" class="btIcoHolder"></a></div>'
      );
    ...
    $(".btCustomMenu  ul ul")
      .parent()
      .prepend(
        '<div class="btIco borderless extrasmall customSubToggler"><a href="#" data-ico-fa="&#xf107;" class="btIcoHolder"></a></div>'
      );
    ...
    bt_enquire.register(
      "screen and (max-width:" + responsiveResolution + "px)",
      {
        match: function () {
          undivide_menu();
          if (!verticalMenuEnabled) {
            $("body")
              .addClass("btMenuVerticalLeft")
              .removeClass(
                "btMenuLeft btMenuCenter btMenuRight btMenuVerticalRight"
              );
            $(".menuPort").prependTo("body");
            $(".mainHeader .logo").clone().prependTo(".menuPort");
