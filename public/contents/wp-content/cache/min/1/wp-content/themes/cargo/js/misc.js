...
(function ($) {
  ...
  $(window).ready(function () {
    ...
    if ($(".btRemoveGhost").length == 0 && $(".btGhost").length > 0) {
      window.bt_theme_allow_scroll = !1;
      bt_disable_scroll();
    }
  });
  $(window).load(function () {
    window.bt_theme_loaded = !0;
  ...
  $(document).ready(function () {
    ...
    $(".rowItem.btMiddleVertical, .rowItem.btBottomVertical")
      .parent()
      .addClass("btTableRow");
    $("#boldSiteFooterWidgetsRow")
      ...
      .addClass(
        "rowItem col-md-" +
          Math.round(12 / $("#boldSiteFooterWidgetsRow").children().length) +
          " col-sm-12"
      );
    ...
    $(".btCloseGhost").on("click", function () {
      if (!$(".btGhost").hasClass("btRemoveGhost")) {
        ...
        setTimeout(function () {
          window.bt_theme_allow_scroll = !0;
