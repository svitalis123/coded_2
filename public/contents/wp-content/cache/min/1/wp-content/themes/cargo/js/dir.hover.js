  ...
  $(document).ready(function () {
    ...
    function initTilesGridHover() {
      $(".btPageWrap").on("mouseenter", ".bpgPhoto", function (event) {
        ...
        bt_selected_gridItemEnter.removeClass(
          "in-top in-left in-right in-bottom out-top out-left out-right out-bottom"
        );
      ...
      $(".btPageWrap").on("mouseleave", ".bpgPhoto", function (event) {
        ...
        var dir = getHoverDir($(this), event.pageX, event.pageY);
        bt_selected_gridItemLeave.removeClass(
          "in-top in-left in-right in-bottom out-top out-left out-right out-bottom"
        );
        switch (dir) {
          case 0:
